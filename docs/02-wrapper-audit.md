...
One file, `src/server.py` (341 lines), `FastMCP` + 5 task tools. (Its path, at fork time; this repo's copy moved to `better_rlm/` later and has grown well past that size.)
